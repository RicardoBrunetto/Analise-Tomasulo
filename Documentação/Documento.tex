...
\end{titlepage}
	...
	\begin{itens}
		...
		\item \textbf{Desvantagens}
			\subitem Alto tráfego no baramento causado por leituras seguidas de escritas gerando duas requisições externas seguidas.
			\subitem Alto tráfego no baramento e alto custo causado pelo \textit{flush} (\textit{write-back}) de blocos que são lidos por outras caches.
	\end{itens}
	...
	\begin{itens}
		\item \textbf{Vantagens}
			...
			\subitem Soluciona o problema do alto tráfego no baramento causado por leituras seguidas de escritas gerando duas requisições externas seguidas. ISso porque se o Controlador
			da Cache necessitar modificar uma linha de cache que está no estado exclusivo, nenhuma comunicação via barramento é necessitada.
		\item \textbf{Desvantagens}
			\subitem Mantém o problema de alto tráfego no baramento e alto custo causado pelo \textit{flush} (\textit{write-back}) de blocos que são lidos por outras caches.
			...
			de suas respectivas caches, então aquele dado será único no sistema, mas não será promovido.
	\end{itens}
	...
	\begin{itens}
		\item \textbf{Vantagens}
			\subitem Não há alto tráfego no baramento causado por leituras seguidas de escritas gerando duas requisições externas seguidas.
			\subitem Não há alto tráfego no baramento e alto custo causado pelo \textit{flush} (\textit{write-back}) de blocos que são lidos por outras caches.
